...
```
cd existing_repo
git remote add origin https://gitlab.com/algoritimos-ifc/algoritimosif.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/algoritimos-ifc/algoritimosif/-/settings/integrations)
